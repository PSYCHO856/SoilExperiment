    ...
    public class LoopListViewItem2 : MonoBehaviour
    {
        ...
        public RectTransform CachedRectTransform
        {
            get
            {
                ...
                //Debug.Log("来了哟下===================");
                //Debug.Log(mCachedRectTransform.rect.height);
                //Debug.Log(mCachedRectTransform.sizeDelta.x);
        ...
        public float ItemSize
        {
            get
            {
                if (ParentListView.IsVertList)
                {
                    ...
                    if (CachedRectTransform.rect.height==0)
                    {
                        CachedRectTransform.sizeDelta = new Vector2(CachedRectTransform.sizeDelta.x, vector.y);
                    }
                    return vector.y;
                }
                else
                {
                    ...
                    if (CachedRectTransform.rect.width == 0)
                    {
                        CachedRectTransform.sizeDelta = new Vector2(vector.x, CachedRectTransform.sizeDelta.y);
                    }
                    return vector.x;
                }
            }
