...
public class FPSPlayerControl : MonoBehaviour {
	...
	public void GunFire(){
		...
		if (armoCount>0){
            ...
            muzzleEffect.transform.localScale= new UnityEngine.Vector3(Random.Range(0.1f,0.2f), Random.Range(0.1f,0.2f),1);
            ...
            // Impact
            Vector3 screenPos = new UnityEngine.Vector3(Screen.width/2, Screen.height/2,0);
			screenPos += new UnityEngine.Vector3(Random.Range(-10,10), Random.Range(-10,10),0);
