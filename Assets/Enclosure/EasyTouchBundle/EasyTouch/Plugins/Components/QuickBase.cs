...
public class QuickBase : MonoBehaviour {
	...
	protected Vector3 GetInfluencedAxis(){
		...
		case AffectedAxesAction.X:
			axis = new UnityEngine.Vector3(1,0,0);
			break;
		case AffectedAxesAction.Y:
			axis = new UnityEngine.Vector3(0,1,0);
			break;
		case AffectedAxesAction.Z:
			axis = new UnityEngine.Vector3(0,0,1);
			break;
		case AffectedAxesAction.XY:
			axis = new UnityEngine.Vector3(1,1,0);
			break;
		case AffectedAxesAction.XYZ:
			axis = new UnityEngine.Vector3(1,1,1);
			break;
		case AffectedAxesAction.XZ:
			axis = new UnityEngine.Vector3(1,0,1);
			break;
		case AffectedAxesAction.YZ:
			axis = new UnityEngine.Vector3(0,1,1);
			break;
		}	
