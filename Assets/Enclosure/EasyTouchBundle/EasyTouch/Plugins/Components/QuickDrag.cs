...
public class QuickDrag: QuickBase {
	...
	private Vector3 GetPositionAxes(Vector3 position){
		...
		case AffectedAxesAction.X:
			axes = new UnityEngine.Vector3(position.x, transform.position.y, transform.position.z);
			break;
		case AffectedAxesAction.Y:
			axes = new UnityEngine.Vector3(transform.position.x, position.y, transform.position.z);
			break;
		case AffectedAxesAction.Z:
			axes = new UnityEngine.Vector3(transform.position.x, transform.position.y, position.z);
			break;
		case AffectedAxesAction.XY:
			axes = new UnityEngine.Vector3(position.x, position.y, transform.position.z);
			break;
		case AffectedAxesAction.XZ:
			axes = new UnityEngine.Vector3(position.x, transform.position.y, position.z);
			break;
		case AffectedAxesAction.YZ:
			axes = new UnityEngine.Vector3(transform.position.x, position.y, position.z);
			break;
		}
