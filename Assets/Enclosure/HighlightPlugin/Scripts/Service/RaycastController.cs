...
namespace HighlightingSystem.Demo
{
	...
	[RequireComponent(typeof(HighlighterInteractionDemo))]
	public class RaycastController : MonoBehaviour
	{
		...
		private Camera cam;
		private HighlighterInteractionDemo interaction3D;
		...
		void Awake()
		{
			...
			interaction3D=GetComponent<HighlighterInteractionDemo>();
			onHover.AddListener(interaction3D.OnHover);//添加点击显示高亮的事件监听-必加组件
		}
