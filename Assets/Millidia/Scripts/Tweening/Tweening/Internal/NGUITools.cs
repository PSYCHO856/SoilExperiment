...
//    }
	...
	static public Vector3[] GetSides (this Camera cam, float depth, Transform relativeTo)
	{
...
#endif
		{
            ...
            mSides[0] = rot * (new UnityEngine.Vector3(x0, 0f, depth)) + pos;
            mSides[1] = rot * (new UnityEngine.Vector3(0f, y1, depth)) + pos;
            mSides[2] = rot * (new UnityEngine.Vector3(x1, 0f, depth)) + pos;
            mSides[3] = rot * (new UnityEngine.Vector3(0f, y0, depth)) + pos;
		}
		else
		{
            mSides[0] = cam.ViewportToWorldPoint(new UnityEngine.Vector3(0f, 0.5f, depth));
            mSides[1] = cam.ViewportToWorldPoint(new UnityEngine.Vector3(0.5f, 1f, depth));
            mSides[2] = cam.ViewportToWorldPoint(new UnityEngine.Vector3(1f, 0.5f, depth));
            mSides[3] = cam.ViewportToWorldPoint(new UnityEngine.Vector3(0.5f, 0f, depth));
		}
	...
	static public Vector3[] GetWorldCorners (this Camera cam, float depth, Transform relativeTo)
	{
...
#endif
		{
            ...
            mSides[0] = rot * (new UnityEngine.Vector3(x0, y0, depth)) + pos;
            mSides[1] = rot * (new UnityEngine.Vector3(x0, y1, depth)) + pos;
            mSides[2] = rot * (new UnityEngine.Vector3(x1, y1, depth)) + pos;
            mSides[3] = rot * (new UnityEngine.Vector3(x1, y0, depth)) + pos;
		}
		else
		{
            mSides[0] = cam.ViewportToWorldPoint(new UnityEngine.Vector3(0f, 0f, depth));
            mSides[1] = cam.ViewportToWorldPoint(new UnityEngine.Vector3(0f, 1f, depth));
            mSides[2] = cam.ViewportToWorldPoint(new UnityEngine.Vector3(1f, 1f, depth));
            mSides[3] = cam.ViewportToWorldPoint(new UnityEngine.Vector3(1f, 0f, depth));
		}
