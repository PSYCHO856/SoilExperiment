...
static public class NGUIEditorTools
{
		...
		int x, int y, int width, int height, int borderLeft, int borderBottom, int borderRight, int borderTop)
	{
		...
		if (Selection.activeGameObject == null || Selection.gameObjects.Length == 1)
		{
            ...
            Handles.DrawLine(new UnityEngine.Vector3(outerRect.xMin, outerRect.yMin), new UnityEngine.Vector3(outerRect.xMin, outerRect.yMax));
            Handles.DrawLine(new UnityEngine.Vector3(outerRect.xMax, outerRect.yMin), new UnityEngine.Vector3(outerRect.xMax, outerRect.yMax));
            Handles.DrawLine(new UnityEngine.Vector3(outerRect.xMin, outerRect.yMin), new UnityEngine.Vector3(outerRect.xMax, outerRect.yMin));
            Handles.DrawLine(new UnityEngine.Vector3(outerRect.xMin, outerRect.yMax), new UnityEngine.Vector3(outerRect.xMax, outerRect.yMax));
